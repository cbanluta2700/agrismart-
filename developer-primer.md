...
flowchart TD
    ...
    B --> B1[Active State.md]
    B --> B2[System Context.md]
    B --> B3[Implementation-Checklist.md]
    B --> B4[Architecture Decisions.md]
    B --> B4[Architecture Decisions.md]
...
* Active State.md (Example - Initial state):
 ```markdown
...
* Implementation-Checklist.md (Example - Tracking progress):
 ```markdown
 # memory-bank/Implementation-Checklist.md
...
* Active State.md (Refactoring plan & progress):
 ```markdown
 # memory-bank/Active State.md
...
* Architecture Decisions.md (Example decisions):
 ```markdown
...
* Implementation-Checklist.md (Tracking refactoring progress):
 ```markdown
 # memory-bank/Implementation-Checklist.md

 Work Done
 - [Initially empty]
 - [After analysis and planning]: - Refactoring plan for `utils/legacy_module.py` documented in `Active State.md` and `Architecture Decisions.md`.
...
* Active State.md (Bug investigation & details):
 ```markdown
 # memory-bank/Active State.md
...
* Architecture Decisions.md (Debugging decisions & findings):
 ```markdown
 # memory-bank/Architecture Decisions.md
...
* Implementation-Checklist.md (Bug fix progress):
 ```markdown
 # memory-bank/Implementation-Checklist.md

 Work Done
 - [Initially empty]
 - [After initial investigation]: - User login bug documented in `Active State.md`. Debugging started.
...
2. Step 1: User makes changes to Memory Bank files (`System Context.md`, `Active State.md`, `Implementation-Checklist.md`, etc.)
